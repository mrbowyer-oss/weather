...
def fetch_weather():
    ...
    try:
        response = requests.get("https://api.open-meteo.com/v1/forecast", params={
            ...
            "daily": "sunrise,sunset,precipitation_probability_max,windspeed_10m_max",
        ...
        # Convert daily max windspeed from m/s to mph
        wind_speed_mph = round(daily["windspeed_10m_max"][0] * 2.23694, 1)
